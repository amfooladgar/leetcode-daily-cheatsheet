...
<td align="center" width="50%">
<b>OpenAI renderer</b><br/>(GPT Image, card sent as a reference image, <code>image_generation.provider: "openai"</code>)<br/><br/>
...
flowchart TD
    ...
    renderer -->|openai| generated["GPT Image draws the card<br/>from a reference image input"]
...
│   ├── rendering/       # HTML/CSS & OpenAI rendering providers
